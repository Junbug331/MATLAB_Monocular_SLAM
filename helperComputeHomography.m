function [H, score, inliersIndex] = helperComputeHomography(matchedPoints1, ...
    matchedPoints2)

[H, inliersLogicalIndex] = estimateGeometricTransform2D(matchedPoints1, matchedPoints2, ... 
    "projective", MaxNumTrials=1e3, MaxDistance=4, Confidence=90);
