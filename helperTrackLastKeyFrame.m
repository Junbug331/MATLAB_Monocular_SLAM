...
% returns the orientation and location of a calibrated camera in a world 
% coordinate system
% world_Pose_cam
...
%   returns a rigid3d object that contains the transformation from world 
%   coordinates to camera coordinates. cameraPose is the orientation and 
%   location of the camera in world coordinates, specified as a rigid3d object.
%   currPose : world_pose_cam
%   [R, t] : cam_pose_world
