...
for i = 1:numel(keyFramesIndices)
    ...
    % Matlab R2021a follows "postmultiply" conventions
    % ex) [x y 1] = [u v l] * T
    % in premultiply convention
    % relpose = rigid3d(prePose.Rotation' * cameraPose.Rotation, ...
    %   prePose.Rotation * (cameraPose.Translation-prePose.Translation))
    
    % postmultiply convention 
